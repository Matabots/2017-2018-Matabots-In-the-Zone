...
#pragma config(Motor,  port3,           LInsideMots,   tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port8,           RInsideMots,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           REdgeMots,     tmotorVex393_MC29, openLoop)
